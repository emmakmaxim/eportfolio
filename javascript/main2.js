...
function setSectionHeight(elem){
  document.getElementById("development-container").style.height = elem.style.height;
  document.getElementById("design-container").style.display = elem.style.height;
  document.getElementById("research-container").style.display = elem.style.height;
}
...
function validateForm() {
    var x = document.forms["contact-form"]["sender"].value;
    var y = document.forms["contact-form"]["contact-organisation"].value;
    var z = document.forms["contact-form"]["senderEmail"].value;
    if (x == "") {
